...
<div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="mb-8">
        ...
        <h1 class="text-3xl font-bold text-gray-900 mt-4">Редактировать пользователя</h1>
    </div>
            ...
            <div class="border-t border-gray-200 pt-4">
                <label class="flex items-start space-x-3 cursor-pointer">
                    ...
                    <input type="checkbox" name="unlimited_messages" id="unlimited_messages" value="1"
                        ...
                        class="mt-0.5 h-5 w-5 rounded border-gray-300 text-blue-600 focus:ring-primary">
                    <span>
                        <span class="block text-sm font-medium text-gray-700">♾️ Безлимитные сообщения</span>
                        <span class="block text-xs text-gray-500 mt-1">Пользователь остаётся на тарифе «Старт», но может писать без ограничения в 20 сообщений.</span>
                    </span>
                </label>
            </div>
