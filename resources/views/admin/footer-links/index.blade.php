...
<div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="mb-8">
        ...
        <h1 class="text-3xl font-bold text-gray-900 mt-4">Меню футера</h1>
    </div>
    ...
    <div class="grid md:grid-cols-2 gap-6">
        ...
        <div class="bg-white shadow rounded-lg p-6">
            ...
            <div class="space-y-3">
                ...
                @empty
                    <p class="text-gray-500">Пока нет ссылок</p>
                @endforelse
            </div>
        </div>
        ...
        <div class="bg-white shadow rounded-lg p-6">
            ...
            <form method="POST" action="{{ route('admin.footer-links.store') }}" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="title" required class="w-full border border-gray-300 rounded px-3 py-2" placeholder="О нас">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">URL</label>
                    <input type="text" name="url" required class="w-full border border-gray-300 rounded px-3 py-2" placeholder="/about или https://...">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Порядок сортировки</label>
                    <input type="number" name="sort_order" value="0" class="w-full border border-gray-300 rounded px-3 py-2">
                </div>
                <div class="flex items-center">
                    <input type="checkbox" name="is_external" id="is_external" class="mr-2">
                    <label for="is_external" class="text-sm text-gray-700">Внешняя ссылка (открывать в новой вкладке)</label>
                </div>
