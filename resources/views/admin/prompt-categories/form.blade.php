...
<div class="max-w-2xl mx-auto bg-white dark:bg-gray-800 rounded-lg shadow p-6">
    ...
    <form action="{{ $category ? route('admin.prompt-categories.update', $category) : route('admin.prompt-categories.store') }}" method="POST" class="space-y-4">
        ...
        <div>
            <label class="block text-sm font-medium mb-1 text-gray-700 dark:text-gray-300">Родительская категория (для подраздела)</label>
        ...
        <div>
            <label class="block text-sm font-medium mb-1 text-gray-700 dark:text-gray-300">Название *</label>
        ...
        <div>
            ...
            <p class="text-xs text-gray-500 mt-1">Только латиница, цифры, дефис и подчёркивание</p>
        </div>

        <div>
            <label class="block text-sm font-medium mb-1 text-gray-700 dark:text-gray-300">Иконка (emoji)</label>
        ...
        <div>
            <label class="block text-sm font-medium mb-1 text-gray-700 dark:text-gray-300">Порядок сортировки</label>
        ...
        <div class="flex gap-3 pt-4">
            ...
            <a href="{{ route('admin.prompt-categories.index') }}" class="px-6 py-2 bg-gray-300 text-gray-700 rounded-lg hover:bg-gray-400">Отмена</a>
        </div>
    </form>
</div>
@endsection
